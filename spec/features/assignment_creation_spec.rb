...
def public_assignment_creation_setup
	login_as("instructor6")
...
describe "assignment creation page", js: true do
	...
	it "is able show tab due deadlines" do
		public_assignment_creation_setup
...
describe "review strategy tab", js: true do
	...
	# instructor assign reviews will happen only one time, so the data will not be stored in DB.
